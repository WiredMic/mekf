...
impl Mul<R300> for float_t {
    type Output = R300;

    fn mul(self: float_t, b: R300) -> R300 {
        let mut res = R300::zero();
        let a = self;
        res[0] = a*b[0];
        res[1] = a*b[1];
...
impl Mul<float_t> for R300 {
    type Output = R300;

    fn mul(self: R300, b: float_t) -> R300 {
        let mut res = R300::zero();
        let a = self;
        res[0] = a[0]*b;
        res[1] = a[1]*b;
...
impl Add<R300> for float_t {
    type Output = R300;

    fn add(self: float_t, b: R300) -> R300 {
        let mut res = R300::zero();
        let a = self;
        res[0] = a+b[0];
        res[1] = b[1];
...
impl Add<float_t> for R300 {
    type Output = R300;

    fn add(self: R300, b: float_t) -> R300 {
        let mut res = R300::zero();
        let a = self;
        res[0] = a[0]+b;
        res[1] = a[1];
...
impl ssub<R300> for float_t {
    type Output = R300;

    fn ssub(self: float_t, b: R300) -> R300 {
        let mut res = R300::zero();
        let a = self;
        res[0] = a-b[0];
        res[1] = -b[1];
...
impl subs<R300> for float_t {
    type Output = R300;

    fn subs(self: float_t, b: R300) -> R300 {
        let mut res = R300::zero();
        let a = self;
        res[0] = a[0]-b;
        res[1] = a[1];
