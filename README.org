...
*** Windows
Use [[https://learn.microsoft.com/en-us/windows/wsl/install][WSL2]] and what ever distro. Then use the [[https://nixos.org/download/][guide]] on nixos.org.

* Backlog
Add types using GaMultivector as backend.
- Rotors
  - All interaction with all of the other types
  - Different ways to make a rotor
